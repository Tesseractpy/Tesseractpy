 ...
 */
public class BlockedMessagesFragment extends Fragment
{
    private View BlockedChatsView;
    ...
    public BlockedMessagesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BlockedChatsView = inflater.inflate(R.layout.fragment_blocked_messages, container, false);
        blockList = (RecyclerView) BlockedChatsView.findViewById(R.id.blocked_message_list);
        ...
        PrivateRef = FirebaseDatabase.getInstance().getReference().child("BlockedMessages").child("PrivateChats").child(currentUserID);
        UsersRef = FirebaseDatabase.getInstance().getReference().child("Users");


        return BlockedChatsView;
    }
                                ...
                                if (dataSnapshot.exists())
                                {
                                    ...
                                    holder.itemView.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v)
                                        {
                                            ...
                                            chatIntent.putExtra("from","BlockedMessagesFragment");
